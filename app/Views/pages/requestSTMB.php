                    ...
                    <div class="card-header pb-0">
                        <div class="row">
                            ...
                            <div class="col-9 justify-content-end d-inline-flex">
                                <?php if ($stmb['approve_hrService'] != 'Yes' && in_array(session('id_role'), [2, 7])) : ?>
                                    <form method="POST" action="/approveSTMB/<?= $stmb['id_stmb'] ?>" class="d-inline">
                                ...
                                <?php endif; ?>
                                <?php if ($stmb['approve_hrbp'] != 'Yes' && session('id_role') == 4) : ?>
                                    <form method="POST" action="/approveHrbp/<?= $stmb['id_stmb'] ?>" class="d-inline">
                                        <button type="submit" class="btn btn-outline-success btn-sm d-flex justify-content-center align-items-center" style="width:100px; height:30px;">
                                            <i class="fas fa-check" style="font-size: 15px;"></i>
                                            <span style="font-size: 10px;">Approve</span>
                                        </button>
                                ...
                                <?php endif; ?>
                                <?php if ($stmb['approve_klinik'] != 'Yes' && session('id_role') == 5) : ?>
                                    <form method="POST" action="/approveKlinik/<?= $stmb['id_stmb'] ?>" class="d-inline">
                                        <button type="submit" class="btn btn-outline-success btn-sm d-flex justify-content-center align-items-center" style="width:100px; height:30px;">
                                            <i class="fas fa-check" style="font-size: 15px;"></i>
                                            <span style="font-size: 10px;">Approve</span>
                                        </button>
                                ...
                                <?php endif; ?>
                                <?php if ($stmb['approve_atasan'] != 'Yes' && session('id_role') == 6) : ?>
